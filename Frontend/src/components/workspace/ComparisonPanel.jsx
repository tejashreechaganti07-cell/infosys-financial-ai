...
export const ComparisonPanel = () => {
  ...
  const comparisonData = {
    IT_SERVICES: {
      ...
      rows: [
        ...
        {
          metric: 'Free Cash Flow (FCF) Conversion',
          infy: '88.4%',
          tcs: '86.1%',
          wipro: '91.2%',
          avg: '88.6%',
  ...
  const activeData =
    comparisonData[sector] || comparisonData.IT_SERVICES;
    ...
    >
            ...
            <tr className="border-b border-white/[0.07] text-[11px] font-semibold text-slate-400 uppercase tracking-wider">
              {activeData.headers.map((header, index) => (
                <th
                  ...
                  className={`py-3 px-4 ${
                    index === 1
                      ? 'text-emerald-400 font-bold bg-emerald-500/10 border-l border-r border-emerald-500/20'
                      : ''
                  }`}
                >
                  {header}
      ...
      <div className="mt-4 pt-3 border-t border-white/[0.07] flex items-center justify-between text-xs text-slate-400">
        <span className="flex items-center gap-1.5">
          ...
          <span>
            Extracted via Comparison Agent cross-filing matrix
          </span>
        </span>
