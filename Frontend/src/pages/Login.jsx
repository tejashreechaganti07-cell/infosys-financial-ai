...
export const Login = () => {
  ...
  const highlights = [
    {
      icon: Layers,
      title: 'Multi-agent research workspaces',
      desc: 'Ingest filings and interrogate them conversationally.',
    },
    {
      icon: ShieldCheck,
      title: 'Strict source grounding',
      desc: 'Every answer carries an exact filing citation.',
    },
    {
      icon: FileCheck,
      title: 'Automated analyst reports',
      desc: 'Executive summaries, metrics and red flags in one export.',
    },
  ];
      ...
      <div className="hidden lg:flex flex-col justify-between p-12 xl:p-16 border-r border-white/[0.06]">
        ...
        <div className="max-w-lg animate-fadeUp">
          ...
          <p className="mt-4 text-sm text-slate-400 leading-relaxed">
            A multi-agent system that reads company filings, extracts the
            numbers that matter, flags risk, and cites every claim back to the
            source document.
          </p>
