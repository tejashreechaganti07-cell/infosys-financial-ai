...
export const Reports = () => {
  ...
  const handleExportMarkdown = async (id, title) => {
    try {
      ...
      link.setAttribute(
        'download',
        `${title.replace(/\s+/g, '_')}_Report.md`
      );
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-terminal-border/80">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-1">
            Structured investment summaries with Executive Summary, Financial
            Metrics, Red Flags, and Peer Ratios
          </p>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-3 pt-2 border-t border-terminal-border/50 flex items-center justify-between text-[10px] font-mono text-slate-500">
                    <span>
                      {rep.created_at ? rep.created_at.slice(0, 10) : 'Today'}
                    </span>
          ...
          {selectedReport ? (
              ...
              <div className="space-y-6 text-xs text-slate-300 leading-relaxed">
                ...
                <div className="p-4 rounded-xl bg-amber-500/5 border border-amber-500/20 space-y-2">
                  ...
                  <ul className="list-disc list-inside space-y-1.5 text-slate-300">
                    <li>
                      <strong>BFS Discretionary Spend Softness:</strong> Longer
                      deal conversion cycles in US financial services.
                    </li>

                    <li>
                      <strong>Offshore Wage Revision Schedule:</strong> Planned
                      wage increases in H1 FY25 may temporarily compress EBIT
                      margins.
                    </li>

                    <li>
                      <strong>Auditor Clean Assessment:</strong> Independent
                      auditor (Deloitte Haskins & Sells) verified clean
                      statutory books with zero going-concern warnings.
                    </li>
                  </ul>
                </div>
                ...
                <div className="pt-3 border-t border-terminal-border/80 flex items-center justify-between text-[11px] font-mono text-slate-500">
                  ...
                  <span className="text-emerald-400">
                    CITATIONS VERIFIED AGAINST 20-F / Q4 TRANSCRIPT
                  </span>
                </div>
              </div>
            </Card>
            ...
            <Card title="No Report Selected">
              <p className="text-xs text-slate-400">
                Select a report from the list to inspect.
              </p>
            </Card>
          )}
        </div>
        ...
        <form onSubmit={handleCreateReport} className="space-y-4">
          ...
          <div className="p-3 bg-emerald-500/10 border border-emerald-500/20 rounded-lg text-xs text-emerald-400 space-y-1">
            ...
            <p className="text-slate-300 text-[11px]">
              ...
              <br />
              2. Extract operating KPIs & year-over-year deltas.
              <br />
              3. Highlight automated red flags & auditor status.
              <br />
